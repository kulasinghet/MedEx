...
<!--register popup for the Are you a page?-->
    ...
    <!--search-->
<!--Graph-->
<div class="card" style="width: 30%; height: 500px; left: 35%; top: 192px;">
  <div class="card-body">
    <h2 class="card-title" style="text-align:center;"><img src="../../../public/res/logo/Logo-text.png" alt="logo" height="40px" width="auto"><br>Login</h2>
    <p class="card-text">
