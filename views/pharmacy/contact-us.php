                ...
                <div class="contact-us">
                    ...
                    <form action="/pharmacy/contact-us" method="post">
                        <div class="form-group">
                            ...
                            <select class="form-input" id="subject" name="subject" style="margin-bottom: 5vh;">
                                <option value="request-new-medicine">Request New Medicine</option>
                                <option value="report-side-effects">Report Side Effects</option>
                                <option value="report-order-issues">Report Order Issues</option>
                                <option value="report-website-issues">Report Website Issues</option>
<!--                                <option value="-->
