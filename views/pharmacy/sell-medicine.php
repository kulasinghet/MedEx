                ...
                <table id="order-medicine-table">
                    ...
                    if ($medicines != null) {
                        foreach ($medicines as $medicine) {
                            ...
                            echo "<td  style='text-align: center'><input type='number' name='" . $medicine['medId'] . "' min='0' max='100' placeholder='0' class='order-medicine-quantity' required onchange='handleQtyChange(name)' id='order-medicine-quantity-" . $medicine['medId'] . "'></td>";
//                            <input type='number' name='quantity' id='quantity' placeholder='1 2 3 . . .'>
                            echo "<td style='text-align: center' id='total-price-" . $medicine['medId'] . "' class='total-price-column'>0</td>";
                            echo "</tr>";
...
//                            echo "<td>" . $pharmacyOrderMedicineController->getPrice($medicine['medId']) . "</td>";
...
////            </div>
//                    echo "<div id='order-new-medicine'>";
