...
<div class="sidepanel">
    ...
    <div id="links">
        ...
        <span>
                ...
                <a id="orders" href="/delivery/orders">Orders</a>
            </span>
        <hr>
        <span id="active">
                <i class='fas fa-warehouse' style='color:#333333'></i>
                <a id="history"href="/delivery/history">History</a>
            </span>
        <hr>
        <span>
...
<div class="container">
    <div class="image">
        <img class="image" src="/res/under-construction.svg" alt="under-construction">
    </div>
    <div class="content">
