            ...
            <div class="col card data-box">
                <div class="card-body">
                        ...
                        <div class="col">
                            <table class="status-table">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $store->aprv_one_obj->lab_cert_id?? "N/A" ?></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="row action-buttons">
                        <div class="col">
                            <a class="btn btn--success" href="/employee/approve/lab?et=<?php echo $store->aprv_one_obj->username ?>&a=approve">
                                <i class="fa-solid fa-circle-check"></i>
                            </a>
                        </div>
                        <div class="col">
                            <a class="btn btn--danger" href="/employee/approve/lab?et=<?php echo $store->aprv_one_obj->username ?>&a=ignore">
