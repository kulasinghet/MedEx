...
INSERT INTO `delivery` (`reqId`, `deliveryId`, `acceptDate`) VALUES
('delReq0001', 'D0002', '2022-11-01 09:52:22');
...
INSERT INTO `deliverypartner` (`id`, `username`, `password`, `name`, `license_id`, `driverLicenseName`, `vehicle_no`, `vehicle_type`, `delivery_location`, `max_load`, `reg_date`, `refrigerators`) VALUES
('35152399', 'testDelivery', '$2y$10$AMYRUaq6zsZNK.I26LlbM.JvbKSr3t0ByEsA1g.tqvejcUQ1uw4Uu', 'Test Delivery', 'TestID', 'TestLicense', 'askdhgk', 'TestVehicle', 'TestCity', 4, '2022-12-01', 'on'),
('D0001', 'Amal', 'Amal@123', 'Amal Delivery', 'CE573951', 'license01', 'QL-9002', 'Lorry', 'Galle', 12000, '2022-09-06', '1'),
('D0002', 'ImpEx', 'ImpEx@123', 'ImpEx Deliveries', 'CE565680', 'license02', 'QV-2213', 'Lorry', 'Colombo', 10000, '2022-04-23', '0');
...
INSERT INTO `deliveryreq` (`id`, `location`, `pharmacyId`, `orderId`, `status`) VALUES
('delReq0001', 'Morotuwa', 'P0001', 'order0001', 0),
...
INSERT INTO `delivery_partner_contact` (`id`, `email`, `address`, `mobile`) VALUES
('D0001', 'amal@gmail.com', 'No.01, Dodangoda Rd, Rajgama', '0112877770'),
...
INSERT INTO `employee` (`id`, `username`, `password`, `fName`, `lName`, `age`, `managerId`, `NIC`, `regDate`) VALUES
('35152399', 'testEmployee', '$2y$10$JDu9IM4c6gFv044Ds37nIu0OdzefXsY2UECV1KWVF1j1auGSA3k5u', 'Test', 'Employee', 20, NULL, '200101802072', '2022-12-01');
...
CREATE TABLE IF NOT EXISTS `laboratory` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `username` (`username`),
  UNIQUE KEY `business_registration_id` (`business_registration_id`,`laboratory_certificate_id`,`BusinessRegCertName`,`LabCertName`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `laboratory` (`id`, `username`, `password`, `laboratory_name`, `business_registration_id`, `laboratory_certificate_id`, `BusinessRegCertName`, `LabCertName`, `reg_date`) VALUES
('18967713343', 'testLab', '$2y$10$hBQMN1qjUKRDD1PbawLb.uf75uAuFDc97bL4Hx4EEjaay3tJi.ARi', 'testLabName', 'testBRID', 'testLCID', 'testBRN', 'testLCN', '2022-12-01'),
...
INSERT INTO `laboratory_contact` (`id`, `email`, `address`, `mobile`) VALUES
('L0001', 'info@biovest.com', 'No/14/2, Hedges Court', '0112446774'),
...
INSERT INTO `labreport` (`reqId`, `labId`, `comment`, `verified`) VALUES
('Req001', 'L0001', 'Test Passed', 1),
...
INSERT INTO `labreq` (`id`, `medId`, `SupId`, `recivedDate`, `status`) VALUES
('Req001', 'Med0001', 'S0001', '2022-09-01', 1),
...
INSERT INTO `medicine` (`id`, `medName`, `weight`, `sciName`, `manId`) VALUES
('Med0001', 'Panadol', 500, 'Paracetamol', 'M0001'),
...
CREATE TABLE IF NOT EXISTS `pharmacy` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `username` (`username`),
  UNIQUE KEY `pharmacyRegNo` (`pharmacyRegNo`,`BusinessRegId`,`pharmacyCertId`,`BusinessRegCertName`,`pharmacyCertName`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `pharmacyorder` (`id`, `pharmacyId`, `medId`, `quantity`) VALUES
('order0001', 'P0001', 'Med0001', 500),
...
INSERT INTO `pharmacy_contact` (`id`, `email`, `address`, `mobile`) VALUES
('P0001', 'info@evolve.com', '284 Campus Road, Moratuwa 00100', '0112320667'),
...
CREATE TABLE IF NOT EXISTS `supplier` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `username` (`username`),
  UNIQUE KEY `supplierRegNo` (`supplierRegNo`,`BusinessRegId`,`supplierCertId`,`BusinessRegCertName`,`supplierCertName`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `supplier` (`id`, `username`, `password`, `name`, `supplierRegNo`, `BusinessRegId`, `supplierCertId`, `BusinessRegCertName`, `supplierCertName`, `verified`, `regDate`) VALUES
('456123', 'testSupplier', '$2y$10$e1he4sBtR3A0l6n748.BTuIY3NCumke.CzPcdKxGeObke..88LvrK', 'Test SupplierName', 'TestRNO', 'TestBRID', 'TestSCID', 'TestBRN', 'TestSCN', 0, '2022-12-01'),
('S0001', 'alphainfi', 'alpha@123', 'Alpha Infinity', '12128/D2', '30981', 'SC001', 'business04', 'supplier01', 1, '2022-07-01'),
('S0002', 'asiahealth', 'Asiahealth@123', 'Asia Heath', '13328/D2', '29515', 'SC002', 'business05', 'supplier02', 1, '2022-03-01');
...
INSERT INTO `supplier_contact` (`id`, `email`, `address`, `mobile`) VALUES
('S0001', 'admin@asiahealth.com', 'No 7, Chithra Lane', '0112485391'),
...
INSERT INTO `supplier_medicine` (`supId`, `medId`, `verified`, `quantity`, `unitPrice`) VALUES
('S0001', 'Med0001', 1, 250000, 10),
...
ALTER TABLE `deliveryreq`
  ADD CONSTRAINT `deliveryReq_ibfk_2` FOREIGN KEY (`orderId`) REFERENCES `pharmacyorder` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
